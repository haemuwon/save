...
if(!isset($write['wr_11'])) {
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_11` varchar(255) NOT NULL DEFAULT '' AFTER `wr_10` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_12` varchar(255) NOT NULL DEFAULT '' AFTER `wr_11` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_13` varchar(255) NOT NULL DEFAULT '' AFTER `wr_12` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_14` varchar(255) NOT NULL DEFAULT '' AFTER `wr_13` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_15` varchar(255) NOT NULL DEFAULT '' AFTER `wr_14` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_16` varchar(255) NOT NULL DEFAULT '' AFTER `wr_15` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_17` varchar(255) NOT NULL DEFAULT '' AFTER `wr_16` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_18` varchar(255) NOT NULL DEFAULT '' AFTER `wr_17` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_19` varchar(255) NOT NULL DEFAULT '' AFTER `wr_18` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_20` varchar(255) NOT NULL DEFAULT '' AFTER `wr_19` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_11_txt` text NOT NULL DEFAULT '' AFTER `wr_11` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_12_txt` text NOT NULL DEFAULT '' AFTER `wr_12` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_13_txt` text NOT NULL DEFAULT '' AFTER `wr_13` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_14_txt` text NOT NULL DEFAULT '' AFTER `wr_14` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_15_txt` text NOT NULL DEFAULT '' AFTER `wr_15` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_16_txt` text NOT NULL DEFAULT '' AFTER `wr_16` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_17_txt` text NOT NULL DEFAULT '' AFTER `wr_17` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_18_txt` text NOT NULL DEFAULT '' AFTER `wr_18` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_19_txt` text NOT NULL DEFAULT '' AFTER `wr_19` ");
    sql_query(" ALTER TABLE `{$write_table}` ADD `wr_20_txt` text NOT NULL DEFAULT '' AFTER `wr_20` ");
}

if($w==''){
	$total_count = $board['bo_count_write'];
	if(isset($type) && $type == "pair" && $total_count < 2) {
...
<section id="bo_w">
	...
	<table class="theme-form">
		...
		<? if ($is_category & (!isset($type) || $type != "pair")) { ?>
		<tr>
	...
	<div class="btn_confirm">
		...
		<?php if (isset($delete_href) && $delete_href) { ?><a href="<?php echo $delete_href ?>" class="ui-btn etc" onclick="del(this.href); return false;"><i class="material-icons">delete</i> 삭제</a><?php } ?>
