	...
	if ($is_notice || $is_html || $is_secret || $is_mail) {
		...
		$sec .='<option value="member" '.$mem_select.'>멤버공개</option>';}
			...
			<div>
				...
				<dl class="dl-title">
					<dt>
						<label for="wr_2">제목</label>
					</dt>
					<dd>
						<input type="text" name="wr_2" value="<?php if($w=="u"){echo$write['wr_2'];} ?>" id="wr_2" class="frm_input" size="50">
					</dd>
				</dl>
				<dl class="dl-subtitle">
					<dt>
						<label for="wr_3">부제</label>
					</dt>
					<dd>
						<input type="text" name="wr_3" value="<?php if($w=="u"){echo$write['wr_3'];} ?>" id="wr_3" class="frm_input" size="50">
					</dd>
				</dl>
				<dl class="dl-memo">
					<dt>
