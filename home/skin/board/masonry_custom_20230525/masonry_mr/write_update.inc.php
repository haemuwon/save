...
if($cookie){
	...
	if($w!='c' && $w!='cu'){
		...
		$customer_sql .= " ,wr_option='$html,$sec', wr_secret='{$mem}' , wr_protect= '{$protect}'";
	...
	unset($temp);
	$customer_sql .= ",wr_reply_more = '{$wr_reply_more}', wr_video = '{$wr_video}', wr_text= '{$wr_text}', wr_secret='{$mem}'";
