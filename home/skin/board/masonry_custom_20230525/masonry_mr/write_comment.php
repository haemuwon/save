...
<aside class="bo_vc_w" id="bo_vc_w_<?=$list_item['wr_id']?>">
	...
	<div class="input-comment"> 
		...
		**********************************************/?>
		...
		<p class="memo_box"><input type="text" name="wr_1" class="wr_1 frm_input full" placeholder="memo"><a href="#" onclick="$(this).parent().prev().slideToggle();return false;" class="ui-btn"><span>▲</span></a></p>
		...
		<?}?>
			...
			<label for="wr_reply_more_<?=$list_item['wr_id']?>">접기</label></span>
