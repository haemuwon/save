...
<aside class="bo_vc_w" id="bo_vc_w_<?=$list_item['wr_id']?>">
	...
	<input type="hidden" name="comment_effect" value="">
	...
	<?}?>
		...
		<!--	 <input type="text" name="wr_effect" class="re-effect frm_input" id="wr_effect_<?=$list_item['wr_id']?>" >-->
			 			<select name="wr_effect" class="re-effect" id="wr_effect_<?=$list_item['wr_id']?>"?>/>
						<option value="">이미지 효과</option>
					<option value="1" >흰 외곽선</option>
