...
if($board['bo_table_width'] == 0 ) 	$board['bo_table_width'] = '100';
...
$pg_anchor = '<ul class="anchor">
	...
	<li><a href="#anc_002">디자인/양식</a></li>
	<li><a href="#anc_003">기능 설정</a></li> 
	<li><a href="#anc_004">권한 설정</a></li>
...
<section id="anc_001">
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			...
			<td colspan="2">
				<input type="hidden" name="gr_id" value="<?=$board['gr_id'] ? $board['gr_id'] : 'original'?>"> 
		...
		<tr>
			...
			<td colspan="2">
				<select id="bo_type" name="bo_type">
					...
					<option value="mmb" <?=$board['bo_type'] == 'mmb' ? "selected" : ""?>>로그 게시판</option>
				</select>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="2">
				<input type="text" name="bo_pass" value="<?=$board['bo_pass']?>" id="bo_pass" class="frm_input" size="80" maxlength="120">
				<label for="bo_use_pass"><input type="checkbox" name="bo_use_pass" id="bo_use_pass" value="1" <?=$board['bo_use_pass']==1 ? "checked":"";?>> 비밀번호 사용</label>
			</td>
		</tr>
		<?php if ($w == 'u') { ?>
		<tr>
...
<section id="anc_002">
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			...
			<td>
				<?php echo help('게시판에서 출력되는 이미지의 폭 크기. 0 입력시 제한하지 않습니다.') ?>
		...
		<tr>
			<th scope="row"><label for="bo_gallery_height">로그/갤러리 세로기준<strong class="sound_only">필수</strong></label></th>
			<td>
				<?=help("로드 게시판의 경우 자동 접기 기준, 갤러리형 게시판의 경우 목록의 세로 높이를 설정합니다.")?>
		...
		<tr>
			...
			<td> 
				...
				<input type="text" name="bo_gallery_width" value="<?php echo $board['bo_gallery_width'] ?>" id="bo_gallery_width" required class="required numeric frm_input" size="4"> 픽셀
			</td>
			<td class="td_grpset">
		...
		<tr>
			...
			<td>
				...
				<input type="text" name="bo_gallery_cols" value="<?php echo $board['bo_gallery_cols'] ?>" id="bo_gallery_cols" required class="required numeric frm_input" size="3">
			</td>
			<td class="td_grpset">
...
<section id="anc_003">
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			<th scope="row"><label for="bo_use_chick">이미지 선업로드(췩) 사용</label></th>
			<td>
		...
		<tr >
            ...
            <td>
				<?=help("전체검색 사용시 메뉴에 노출됩니다.(기본메뉴사용시)")?>
