...
function editor_html($id, $content, $is_dhtml_editor=true)
{
    ...
    if ($is_dhtml_editor && $js) {
		...
		$html .= "\n".'<style>';
		$html .= "\n".'.cke_sc_def .btn_cke_sc_close {clear:both;margin:10px;}';
		$html .= "\n".'.cke_sc_def .smart_shortcut{float:none;overflow:hidden;clear:both;padding:3px;}';
		$html .= "\n".'.cke_sc_def .smart_shortcut dt{float:left;margin-left:30px;width:70px;border-bottom:1px solid #aaa;}';
		$html .= "\n".'.cke_sc_def .smart_shortcut dd{float:left;margin-left:5px;width:70px;border-bottom:1px solid #aaa;}</style>';
