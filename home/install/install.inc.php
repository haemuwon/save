...
<h2 style="text-align:center;"> php 버전이 호환되지 않아 솔루션을 설치할 수 없습니다.<br> 
본 솔루션은 언어셋 utf-8, php 5.2~5.6 버전에서만 정상 작동합니다.<br>
호스팅 환경 변경 서비스를 이용하시거나 설치 가능한 환경의 계정을 새로 세팅해주세요.
</h2>
	<?}else{
	// 파일이 존재한다면 설치할 수 없다.
...
<h3 style="text-align:center;">
	php 버전이 5.x 버전이 아닙니다. 일부 상황에서 오류가 발생할 수 있습니다.<br />
	보다 안정적인 호환을 위해 php 5버전으로 환경을 변경하시는 것을 추천합니다.
</h2>	
<?}?>
