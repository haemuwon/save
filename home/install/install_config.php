...
<div class="ins_inner">
	...
	<tr>
        <th scope="row"><label for="community_title">홈페이지 제목</label></th>
        <td>
            <input name="community_title" type="text" value="" id="community_title">
        </td>
    </tr>
    </tbody>
    </table>
...
function frm_install_submit(f)
{
    ...
    }  else if (f.community_title.value == '')
    {
        alert('홈페이지 제목을 입력하십시오.'); f.community_title.focus(); return false;
    }
